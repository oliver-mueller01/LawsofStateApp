                                ...
                                <AccordionContent>
                                    ...
                                    <Accordion type="multiple" className="w-full mt-2">
                                        {category.laws.map((law) => {
                                            const isTitle = !law.body || law.body.trim() === "<p></p>" || law.name.toLowerCase().includes("titel") || law.name.toLowerCase().includes("teil")

                                            if (isTitle) {
                                                return (
                                                    <div key={law.id} className="mt-6 mb-3 text-primary font-bold text-base border-b border-primary/30 pb-1 uppercase tracking-wide">
                                                        {law.name}
                                                    </div>
                                                )
                                            }
                                            ...
                                            return (
                                                <AccordionItem key={law.id} value={law.id} className="border-l-2 border-primary/20 pl-3">
